...
class MAINMODULE_EXPORT OscWidget : public QDialog, private Ui::OscWidget
{
    ...
    public slots:
        ...
        void on_channelGroup_buttonClicked( QAbstractButton* );
        void on_autoGroup_buttonClicked( QAbstractButton* );
        void on_triggerGroup_buttonClicked( QAbstractButton* );
        void on_hideGroup_buttonClicked( QAbstractButton* );
        void on_trackGroup_buttonClicked( QAbstractButton* );
    ...
    protected:
        ...
        void mouseReleaseEvent( QMouseEvent* ) { m_action = actNone; setCursor( Qt::ArrowCursor ); }
