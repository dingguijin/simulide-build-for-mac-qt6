...
bool Processor::isIntArg64Register(unsigned char number, unsigned char) {
    return number < 6;
}

bool Processor::isFloatArg64Register(unsigned char number, unsigned char) {
    return number < 8;
}

Register Processor::intArg64(unsigned char number, unsigned char) {
    switch(number) {
        case 0:
...
Register Processor::floatArg64(unsigned char number, unsigned char) {
    switch(number) {
        case 0:
